...
nohup java -jar ../key-service/target/key-service-0.0.1-SNAPSHOT.jar &
sleep 5
echo "Finished launching key-service."

echo "Launching transaction-service at"  `date`
nohup java -jar ../transaction-service/target/transaction-service-0.0.1-SNAPSHOT.jar &
sleep 15
echo "Finished launching transaction-service."

echo "Report Generation Scheduler at " `date`
java -jar ../report-executor/target/report-executor-0.0.1-SNAPSHOT.jar
echo
echo
